...
import com.example.view.MyListView.OnScrollOverListener;
...
public class PullView extends LinearLayout implements OnScrollOverListener{
	...
	private void initHeaderViewAndFooterViewAndListView(Context context){
		...
		mHeaderView = LayoutInflater.from(context).inflate(R.layout.head_layout, null);
		...
		mFooterView = LayoutInflater.from(context).inflate(R.layout.foot_layout, null);
